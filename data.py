...
if sys.version_info[0] == 2:
    ...
    import pickle
# from sklearn.model_selection import train_test_split    #this line causes: # import matplotlib.pyplot as pltImportError: dynamic module does not define module export function (PyInit_ckdtree)
