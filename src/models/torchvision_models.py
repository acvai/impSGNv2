...
#	pose_net = nn.Sequential(*list(models.resnet18(weights=pretrained).children())[:-1])
	pose_net = models.resnet18(weights=pretrained)
	print(pose_net)
	assert False, '--------a---------'

#	pose_net.layer4.BasicBlock[0].conv1 = nn.Conv2d(111, 
#					111,
#					kernel_size=(3, 3), 
#					stride=(1, 1), 
#					padding=(1, 1), 
...
#	assert False
	...
	for i in range(4):
		layer = "layer"+str(i)
		pose_net.layer3[i].conv1 = nn.Conv2d(111, 
						111,
						kernel_size=(3, 3), 
						stride=(1, 1), 
						padding=(1, 1), 
